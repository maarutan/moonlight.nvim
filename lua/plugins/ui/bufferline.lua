...
return {
	...
	opts = {
		options = {
			...
			indicator = {
				icon = const.icons.ui.listchars.vertical_space_bar, -- this should be omitted if indicator style is not 'icon'
			...
			buffer_close_icon = " " .. const.icons.ui.close .. " ",
			modified_icon = const.icons.ui.not_save,
			close_icon = " " .. const.icons.ui.close .. " ",
			left_trunc_marker = const.icons.ui.left_trunc_marker,
			right_trunc_marker = const.icons.ui.right_trunc_marker,
