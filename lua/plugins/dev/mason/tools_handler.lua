...
local tools_by_ft = {
	...
	javascriptreact = { "typescript-language-server", "prettier", "emmet-ls", "html-lsp", "css-lsp" },
	typescriptreact = { "typescript-language-server", "prettier", "emmet-ls", "html-lsp", "css-lsp" },
