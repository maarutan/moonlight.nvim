-- lua/plugins/navigation/neo_tree/modules/events.lua
local r = require
...
return {
...

	{
		...
		handler = function(args)
			...
			if path and path ~= "" then open_files[path] = nil end
		end,
	},

	{
		event = event.FILE_MOVED,
		handler = function(data) sr.on_rename_file(data.source, data.destination) end,
	},
